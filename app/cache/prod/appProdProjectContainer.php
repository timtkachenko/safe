...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'Z:/home/symfony2/www/safe/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('Z:/home/symfony2/www/safe/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'safe', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'Z:/home/symfony2/www/safe/app/cache/prod/jms_diextra/doctrine/EntityManager_50bfb847745c5.php';
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_cf5c221532436da9c936a33c981467bc');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_cf5c221532436da9c936a33c981467bc');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_cf5c221532436da9c936a33c981467bc');
        ...
        $h->setProxyDir('Z:/home/symfony2/www/safe/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50bfb847745c5_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('Z:/home/symfony2/www/safe/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('Z:/home/symfony2/www/safe/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('Z:/home/symfony2/www/safe/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('Z:/home/symfony2/www/safe/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['sonata.block.renderer'] = new \Sonata\BlockBundle\Block\TraceableBlockRenderer($this->get('sonata.block.manager'), $this->get('logger'), false);
    }
    ...
    {
        return $this->services['sonata.cache.esi'] = new \Sonata\CacheBundle\Adapter\EsiCache('an unique security key', array(), $this->get('router'), $this->get('jms_di_extra.controller_resolver'));
    }
    ...
    {
        return $this->services['sonata.cache.ssi'] = new \Sonata\CacheBundle\Adapter\SsiCache('an unique security key', $this->get('router'), $this->get('jms_di_extra.controller_resolver'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/translations', 'debug' => false));
    ...
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $b = $this->get('router');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'Z:/home/symfony2/www/safe/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'Z:/home/symfony2/www/safe/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $f->setCacheDir('Z:/home/symfony2/www/safe/app/cache/prod/jms_security/expressions');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('50bfb846e0389'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('50bfb846e0389'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'extra', $c, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('50bfb846e0389'), 6 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'secured_area', $c, true)), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('Z:/home/symfony2/www/safe/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'Z:/home/symfony2/www/safe/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod',
            ...
            'session.save_path' => 'Z:/home/symfony2/www/safe/app/cache/prod/sessions',
            ...
            'router.resource' => 'Z:/home/symfony2/www/safe/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'Z:/home/symfony2/www/safe/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'Z:/home/symfony2/www/safe/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'Z:/home/symfony2/www/safe/app/cache/prod/jms_diextra/doctrine/EntityManager_50bfb847745c5.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50bfb847745c5_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'Z:/home/symfony2/www/safe/app/cache/prod/jms_security',
